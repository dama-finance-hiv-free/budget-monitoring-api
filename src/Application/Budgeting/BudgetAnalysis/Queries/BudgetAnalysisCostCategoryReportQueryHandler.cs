...
public class BudgetAnalysisCostCategoryReportQueryHandler : 
    IRequestHandler<BudgetAnalysisCostCategoryReportQuery, ReportFileVm>
{
    ...
    public BudgetAnalysisCostCategoryReportQueryHandler(IRegionPersistence regionPersistence,
    ...
    public async Task<ReportFileVm> Handle(BudgetAnalysisCostCategoryReportQuery request,
        CancellationToken cancellationToken)
    {
        ...
        var options = new BudgetAnalysisOptions()
        {
            ...
            ReportTitle = "BUDGET ANALYSIS BY COST CATEGORY"
        };
