...
public class RoleUsersCommandHandler : 
    IRequestHandler<EditRoleUsersCommand, UserRoleCommandResponse>
{
    private readonly IUserRolePersistence _userRolePersistence;
    private readonly IMapper _mapper;

    public RoleUsersCommandHandler(IRolePersistence rolePersistence, IUserRolePersistence userRolePersistence, IMapper mapper) {
        _userRolePersistence = userRolePersistence;
        _mapper = mapper;
    }

    public async Task<UserRoleCommandResponse> Handle(EditRoleUsersCommand request, CancellationToken cancellationToken)
    {
