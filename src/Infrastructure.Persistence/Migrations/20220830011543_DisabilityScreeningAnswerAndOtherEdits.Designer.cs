...
namespace Immunization.Campaign.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20220830011543_DisabilityScreeningAnswerAndOtherEdits")]
    partial class DisabilityScreeningAnswerAndOtherEdits
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Immunization.Campaign.Domain.Entity.Client.Client", b =>
                {
                    ...
                    b.Property<string>("HADisabilityType")
                        .HasColumnType("text")
                        .HasColumnName("ha_disability_type");

                    b.Property<string>("HAMedicalCondition")
                        .HasColumnType("text")
                        .HasColumnName("ha_medical_condition");
            ...
            modelBuilder.Entity("Immunization.Campaign.Domain.Entity.Client.ClientVaccinationAtBirth", b =>
                {
                    b.Property<string>("Tenant")
                        .HasMaxLength(10)
                        .IsUnicode(false)
                    ...
                    b.HasKey("Tenant", "Code")
                        .HasName("pk_client_vaccination_at_birth");

                    b.ToTable("client_vaccination_at_birth", "client");
                });

            modelBuilder.Entity("Immunization.Campaign.Domain.Entity.Client.ClientVaccinationAtFourteenWeeks", b =>
                {
                    b.Property<string>("Tenant")
                        .HasMaxLength(10)
                        .IsUnicode(false)
                    ...
                    b.HasKey("Tenant", "Code")
                        .HasName("pk_client_vaccination_at_fourteen_weeks");

                    b.ToTable("client_vaccination_at_fourteen_weeks", "client");
                });

            modelBuilder.Entity("Immunization.Campaign.Domain.Entity.Client.ClientVaccinationAtNineMonths", b =>
                {
                    b.Property<string>("Tenant")
                        .HasMaxLength(10)
                        .IsUnicode(false)
                    ...
                    b.HasKey("Tenant", "Code")
                        .HasName("pk_client_vaccination_at_nine_months");

                    b.ToTable("client_vaccination_at_nine_months", "client");
                });

            modelBuilder.Entity("Immunization.Campaign.Domain.Entity.Client.ClientVaccinationAtSixToElevenMonths", b =>
                {
                    b.Property<string>("Tenant")
                        .HasMaxLength(10)
                        .IsUnicode(false)
                    ...
                    b.HasKey("Tenant", "Code")
                        .HasName("pk_client_vaccination_at_six_to_eleven_months");

                    b.ToTable("client_vaccination_at_six_to_eleven_months", "client");
                });

            modelBuilder.Entity("Immunization.Campaign.Domain.Entity.Client.ClientVaccinationAtSixWeeks", b =>
                {
                    b.Property<string>("Tenant")
                        .HasMaxLength(10)
                        .IsUnicode(false)
                    ...
                    b.HasKey("Tenant", "Code")
                        .HasName("pk_client_vaccination_at_six_weeks");

                    b.ToTable("client_vaccination_at_six_weeks", "client");
                });

            modelBuilder.Entity("Immunization.Campaign.Domain.Entity.Client.ClientVaccinationAtTenWeeks", b =>
                {
                    b.Property<string>("Tenant")
                        .HasMaxLength(10)
                        .IsUnicode(false)
                    ...
                    b.HasKey("Tenant", "Code")
                        .HasName("pk_client_vaccination_at_ten_weeks");

                    b.ToTable("client_vaccination_at_ten_weeks", "client");
                });
            ...
            modelBuilder.Entity("Immunization.Campaign.Domain.Entity.Client.VaccinationAtBirth", b =>
                {
                    b.Property<string>("Tenant")
                        .HasMaxLength(10)
                        .IsUnicode(false)
                    ...
                    b.HasKey("Tenant", "Code")
                        .HasName("pk_vaccination_at_birth");

                    b.ToTable("vaccination_at_birth", "client");
                });

            modelBuilder.Entity("Immunization.Campaign.Domain.Entity.Client.VaccinationAtFourteenWeeks", b =>
                {
                    b.Property<string>("Tenant")
                        .HasMaxLength(10)
                        .IsUnicode(false)
                    ...
                    b.HasKey("Tenant", "Code")
                        .HasName("pk_vaccination_at_fourteen_weeks");

                    b.ToTable("vaccination_at_fourteen_weeks", "client");
                });

            modelBuilder.Entity("Immunization.Campaign.Domain.Entity.Client.VaccinationAtNineMonths", b =>
                {
                    b.Property<string>("Tenant")
                        .HasMaxLength(10)
                        .IsUnicode(false)
                    ...
                    b.HasKey("Tenant", "Code")
                        .HasName("pk_vaccination_at_nine_months");

                    b.ToTable("vaccination_at_nine_months", "client");
                });

            modelBuilder.Entity("Immunization.Campaign.Domain.Entity.Client.VaccinationAtSixToElevenMonths", b =>
                {
                    b.Property<string>("Tenant")
                        .HasMaxLength(10)
                        .IsUnicode(false)
                    ...
                    b.HasKey("Tenant", "Code")
                        .HasName("pk_vaccination_at_six_to_eleven_months");

                    b.ToTable("vaccination_at_six_to_eleven_months", "client");
                });

            modelBuilder.Entity("Immunization.Campaign.Domain.Entity.Client.VaccinationAtSixWeeks", b =>
                {
                    b.Property<string>("Tenant")
                        .HasMaxLength(10)
                        .IsUnicode(false)
                    ...
                    b.HasKey("Tenant", "Code")
                        .HasName("pk_vaccination_at_six_weeks");

                    b.ToTable("vaccination_at_six_weeks", "client");
                });

            modelBuilder.Entity("Immunization.Campaign.Domain.Entity.Client.VaccinationAtTenWeeks", b =>
                {
                    b.Property<string>("Tenant")
                        .HasMaxLength(10)
                        .IsUnicode(false)
                    ...
                    b.HasKey("Tenant", "Code")
                        .HasName("pk_vaccination_at_ten_weeks");

                    b.ToTable("vaccination_at_ten_weeks", "client");
                });
