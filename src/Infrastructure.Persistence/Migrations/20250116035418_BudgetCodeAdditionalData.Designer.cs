...
namespace Immunization.Campaign.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20250116035418_BudgetCodeAdditionalData")]
    partial class BudgetCodeAdditionalData
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Dama.Monitoring.Domain.Entity.Budgeting.Activity", b =>
                {
                    ...
                    b.HasKey("Tenant", "Batch", "BatchLine", "Project")
                        .HasName("pk_activity");

                    b.HasIndex("TransDate")
                        .HasDatabaseName("ix_activity_trans_date");
            ...
            modelBuilder.Entity("Dama.Monitoring.Domain.Entity.Budgeting.ActivityHistory", b =>
                {
                    ...
                    b.HasIndex("TransDate")
                        .HasDatabaseName("ix_activity_history_trans_date");
            ...
            modelBuilder.Entity("Dama.Monitoring.Domain.Entity.Budgeting.ActivityPlan", b =>
                {
                    ...
                    b.HasKey("Tenant", "Code", "Project", "CopYear")
                        .HasName("pk_activity_plan");

                    b.ToTable("activity_plan", "budgeting");
                });

            modelBuilder.Entity("Dama.Monitoring.Domain.Entity.Budgeting.ActivityPlanHistory", b =>
                {
                    b.Property<string>("Tenant")
                        .HasMaxLength(10)
                        .IsUnicode(false)
                    ...
                    b.HasKey("Tenant", "Code", "Project", "CopYear")
                        .HasName("pk_activity_plan_history");

                    b.ToTable("activity_plan_history", "budgeting");
                });

            modelBuilder.Entity("Dama.Monitoring.Domain.Entity.Budgeting.AnnualTarget", b =>
                {
                    b.Property<string>("Tenant")
                        .HasMaxLength(10)
                        .IsUnicode(false)
                    ...
                    b.HasKey("Tenant", "Outlay", "CopYear", "Project", "Component", "Region")
                        .HasName("pk_annual_target");

                    b.ToTable("annual_target", "budgeting");
                });
            ...
            modelBuilder.Entity("Dama.Monitoring.Domain.Entity.Budgeting.ComponentActivity", b =>
                {
                    b.Property<string>("Tenant")
                        .HasMaxLength(5)
                        .IsUnicode(false)
                    ...
                    b.HasKey("Tenant", "CopYear", "Component", "Activity")
                        .HasName("pk_component_activity");

                    b.ToTable("component_activity", "budgeting");
                });
            ...
            modelBuilder.Entity("Dama.Monitoring.Domain.Entity.Budgeting.CopYearOutlay", b =>
                {
                    b.Property<string>("Tenant")
                        .HasMaxLength(10)
                        .IsUnicode(false)
                    ...
                    b.HasKey("Tenant", "CopYear", "Project", "Outlay")
                        .HasName("pk_cop_year_outlay");

                    b.ToTable("cop_year_outlay", "budgeting");
                });
            ...
            modelBuilder.Entity("Dama.Monitoring.Domain.Entity.Budgeting.Outlay", b =>
                {
                    b.Property<string>("Tenant")
                        .HasMaxLength(10)
                        .IsUnicode(false)
                    ...
                    b.ToTable("outlay", "budgeting");
                });

            modelBuilder.Entity("Dama.Monitoring.Domain.Entity.Budgeting.OutlayIntervention", b =>
                {
                    b.Property<string>("Tenant")
                        .HasMaxLength(10)
                        .IsUnicode(false)
                    ...
                    b.HasKey("Tenant", "CopYear", "Project", "Outlay", "Intervention")
                        .HasName("pk_outlay_intervention");

                    b.ToTable("outlay_intervention", "budgeting");
                });

            modelBuilder.Entity("Dama.Monitoring.Domain.Entity.Budgeting.PrintDailyData", b =>
                {
                    b.Property<string>("User")
                        .HasMaxLength(10)
                        .IsUnicode(false)
                    ...
                    b.Property<double>("PreviousReceipts")
                        .HasColumnType("double precision")
                        .HasColumnName("previous_receipts");
                    ...
                    b.Property<double>("TodayReceipts")
                        .HasColumnType("double precision")
                        .HasColumnName("today_receipts");
                    ...
                    b.HasKey("User", "Site", "UserCode")
                        .HasName("pk_print_daily_data");

                    b.ToTable("print_daily_data", "budgeting");
                });
            ...
            modelBuilder.Entity("Dama.Monitoring.Domain.Entity.Budgeting.ProjectSite", b =>
                {
                    b.Property<string>("Tenant")
                        .HasMaxLength(10)
                        .IsUnicode(false)
                    ...
                    b.HasKey("Tenant", "copYear", "Project", "Site")
                        .HasName("pk_project_site");

                    b.ToTable("project_site", "budgeting");
                });
            ...
            modelBuilder.Entity("Dama.Monitoring.Domain.Entity.Budgeting.Runner", b =>
                {
                    ...
                    b.HasKey("Tenant", "CopYear", "Code", "Region", "Project")
                        .HasName("pk_runner");
            ...
            modelBuilder.Entity("Dama.Monitoring.Domain.Entity.Budgeting.Strategy", b =>
                {
                    b.Property<string>("Tenant")
                        .HasMaxLength(10)
                        .IsUnicode(false)
                    ...
                    b.ToTable("strategy", "budgeting");
                });

            modelBuilder.Entity("Dama.Monitoring.Domain.Entity.Budgeting.SurgeActivity", b =>
                {
                    b.Property<string>("Tenant")
                        .HasMaxLength(10)
                        .IsUnicode(false)
                    ...
                    b.HasKey("Tenant", "Code")
                        .HasName("pk_surge_activity");

                    b.ToTable("surge_activity", "budgeting");
                });

            modelBuilder.Entity("Dama.Monitoring.Domain.Entity.Budgeting.Target", b =>
                {
                    b.Property<string>("Tenant")
                        .HasMaxLength(10)
                        .IsUnicode(false)
                    ...
                    b.ToTable("target", "budgeting");
                });

            modelBuilder.Entity("Dama.Monitoring.Domain.Entity.Budgeting.TargetHistory", b =>
                {
                    b.Property<string>("Tenant")
                        .HasMaxLength(10)
                        .IsUnicode(false)
                    ...
                    b.ToTable("target_history", "budgeting");
                });
            ...
            modelBuilder.Entity("Dama.Monitoring.Domain.Entity.Common.Ticket", b =>
                {
                    b.Property<string>("Tenant")
                        .HasMaxLength(10)
                        .IsUnicode(false)
                    ...
                    b.ToTable("ticket", "common");
                });

            modelBuilder.Entity("Dama.Monitoring.Domain.Entity.Common.TicketStatus", b =>
                {
                    b.Property<string>("Tenant")
                        .HasMaxLength(10)
                        .IsUnicode(false)
                    ...
                    b.ToTable("ticket_status", "common");
                });
            ...
            modelBuilder.Entity("Dama.Monitoring.Domain.Entity.Common.Week", b =>
                {
                    b.Property<string>("Tenant")
                        .HasMaxLength(10)
                        .IsUnicode(false)
                    ...
                    b.Property<int>("WeekSerial")
                        .HasColumnType("integer")
                        .HasColumnName("week_serial");

                    b.Property<string>("Component")
                        .HasColumnType("text")
                        .HasColumnName("component");

                    b.Property<int>("ComponentWeekSerial")
                        .HasColumnType("integer")
                        .HasColumnName("component_week_serial");
                    ...
                    b.HasKey("Tenant", "CopYear", "WeekSerial")
                        .HasName("pk_week");

                    b.ToTable("week", "common");
                });
