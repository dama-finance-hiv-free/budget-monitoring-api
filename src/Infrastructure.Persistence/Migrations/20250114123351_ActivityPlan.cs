...
{
    public partial class ActivityPlan : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_activity_plan", x => new { x.tenant, x.code, x.project, x.cop_year });
                });

            migrationBuilder.CreateTable(
                name: "activity_plan_history",
                schema: "budgeting",
                columns: table => new
                {
                    tenant = table.Column<string>(type: "character varying(10)", unicode: false, maxLength: 10, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_activity_plan_history", x => new { x.tenant, x.code, x.project, x.cop_year });
                });
        }
