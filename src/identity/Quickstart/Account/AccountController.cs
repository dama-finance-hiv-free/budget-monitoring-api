    ...
    public async Task<IActionResult> Login(LoginInputModel model, string button)
    {
        ...
        if (ModelState.IsValid)
        {
            ...
            if (user != null && (await _signInManager.CheckPasswordSignInAsync(user, model.Password, true)) == SignInResult.Success)
            {
                ...
                if (await _signInManager.UserManager.GetTwoFactorEnabledAsync(user))
                {
    ...
    public async Task<IActionResult> ForgotPassword(ForgotPasswordModel model)
    {
        ...
        if (ModelState.IsValid)
        {
            ...
            if (user != null)
            {
                ...
                body = body.Replace("{Url}", resetUrl).Replace("{UserName}", user.FullName); 
