...
using IdentityProvider.Logging.Middleware;
...
public class Startup
{
        ...
        services.AddIdentity<ApplicationUser, IdentityRole>(options =>
            ...
            .AddPwnedPasswordValidator<ApplicationUser>(options =>
            {
                options.ErrorMessage =
                    $"this password is known to have been compromised more than {considerPwned} times.";
            });
    ...
    {
        //bursar
        var bursar = new ApplicationUser("bursar@cbchs.cm")
        {
            Id = Guid.NewGuid().ToString(),
            Email = "bursar@cbchs.cm",
        ...
        var bursarClaims = new List<Claim>
        {
            new Claim(JwtClaimTypes.Email, "bursar@cbchs.cm"),
            new Claim(JwtClaimTypes.Role, "bursar")
        };
    }
    ...
    {
        if (ex.GetType().Name == nameof(NpgsqlException))
        {
